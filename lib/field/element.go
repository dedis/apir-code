...
// Package field contains field arithmetic operations for modulus 340282366920938463463374607431768211455
package field
...
func init() {
	_modulus.SetString("340282366920938463463374607431768211455", 10)
...
func (z *Element) LexicographicallyLargest() bool {
	...
	_, b = bits.Sub64(_z[1], 9223372036854775808, b)
...
// One returns 0 (in montgommery form)
func Zero() Element {
	var zero Element
	zero.SetZero()
	return zero
...
func init() {
	_bLegendreExponentElement, _ = new(big.Int).SetString("7fffffffffffffffffffffffffffffff", 16)
	const sqrtExponentElement = "40000000000000000000000000000000"
