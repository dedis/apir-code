...
type DatabaseInfoResponse struct {
	...
	IdLength    uint32 `protobuf:"varint,4,opt,name=idLength,proto3" json:"idLength,omitempty"`
...
func (x *DatabaseInfoResponse) GetIdLength() uint32 {
	if x != nil {
		return x.IdLength
	}
	return 0
...
func (x *DatabaseInfoResponse) GetKeyLength() uint32 {
	if x != nil {
		return x.KeyLength
	}
	return 0
...
func (x *ServerStopResponse) Reset() {
	*x = ServerStopResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ServerStopResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServerStopResponse) ProtoMessage() {}

func (x *ServerStopResponse) ProtoReflect() protoreflect.Message {
	mi := &file_lib_proto_vpir_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServerStopResponse.ProtoReflect.Descriptor instead.
func (*ServerStopResponse) Descriptor() ([]byte, []int) {
...
var file_lib_proto_vpir_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x22, 0xac, 0x01, 0x0a, 0x14, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x43, 0x0a, 0x0a, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x53, 0x74, 0x6f, 0x70, 0x12, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x19, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74,
	0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x2c, 0x5a, 0x2a,
...
var file_lib_proto_vpir_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_lib_proto_vpir_proto_goTypes = []interface{}{
	...
	(*ServerStopRequest)(nil),    // 4: proto.ServerStopRequest
	(*ServerStopResponse)(nil),   // 5: proto.ServerStopResponse
}
var file_lib_proto_vpir_proto_depIdxs = []int32{
	...
	4, // 2: proto.VPIR.ServerStop:input_type -> proto.ServerStopRequest
	3, // 3: proto.VPIR.DatabaseInfo:output_type -> proto.DatabaseInfoResponse
	1, // 4: proto.VPIR.Query:output_type -> proto.QueryResponse
	5, // 5: proto.VPIR.ServerStop:output_type -> proto.ServerStopResponse
...
func file_lib_proto_vpir_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_lib_proto_vpir_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ServerStopResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
